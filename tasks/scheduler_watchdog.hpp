...
{
public:
	SchedulerInfoGathererTask(): Thread(11, 1<<10, "SchedulerInfoGatherer"), schedulerInfo_{} 
	{}
	void run()
	{
	...
	const SchedulerInfo& getLatestSchedulerInfo() const {
		return schedulerInfo_;
	}
private:
public:
private:
...
{
public:
	SchedulerWatchdogTask(): Thread(10, 1<<10, "SchedulerWatchdog"), gathererTask_{} 
	{}
	void run()
	{
		...
		while (true)
		{
			...
			MODM_LOG_INFO 	<< "#########################" << modm::endl << modm::endl
							<< gathererTask_.getLatestSchedulerInfo()
							<< "#########################"
							<< modm::endl;
		}
	}
