...
#define MII_PHY_PORT_MAPPING                                                                                           \
    EthernetInterface::RMII_Ref_Clk::Refclk, EthernetInterface::RMII_Mdc::Mdc, EthernetInterface::RMII_Mdio::Mdio,     \
        EthernetInterface::RMII_Crs_Dv::Rcccrsdv, EthernetInterface::RMII_Tx_En::Txen,                                 \
        EthernetInterface::RMII_Tx_D0::Txd0, EthernetInterface::RMII_Tx_D1::Txd1, EthernetInterface::RMII_Rx_D0::Rxd0, \
...
public:
    EthernetManager() { MODM_LOG_INFO << "Ethernet manager initializing ... " << modm::endl; }
    ...
    void registerOnNetworkUpCallback(std::function<void(void)> f) { EthernetManager::userOnNetworkUp_ = f; }
    void registerOnNetworkDownCallback(std::function<void(void)> f) { EthernetManager::userOnNetworkDown_ = f; }
    void onNetworkUp() {
